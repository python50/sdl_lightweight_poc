...
int mprintf (char * buffer, const char * format, ...)
{
...
void rocket::draw()
{
    ...
    stringRGBA(meta::screen, 500, 460, "Z: ", 0X88, 0XFF, 0X88, 0XFF);
    itoa(0, buffer);
    mprintf(buffer, "Well, %d:%d", x, y);
    stringRGBA(meta::screen, 520, 460, buffer, 0X88, 0XFF, 0X88, 0XFF);
}
